...
function twenty(){
  text_p[0].innerHTML = "Percentage  -  70%"
  text_p[1].innerHTML = "Number of Recruiters  -  5"
  text_p[2].innerHTML = "Number of Offers  -  65"
  text_p[3].innerHTML = "Highest CTC  -  17"
  text_p[4].innerHTML = "Average CTC  -  6.2LPA"
  t.style.color = "white"
...
function nine(){
    text_p[0].innerHTML = "Percentage  -  84%"
    text_p[1].innerHTML = "Number of Recruiters  -  5"
    text_p[2].innerHTML = "Number of Offers  -  77"
    text_p[3].innerHTML = "Highest CTC  -  10LPA"
    text_p[4].innerHTML = "Average CTC  -  3.4LPA"
