...
function twenty(){
  text_p[0].innerHTML = "Percentage  -  97.3%"
  text_p[1].innerHTML = "Number of Recruiters  -  16"
  text_p[2].innerHTML = "Number of Offers  -  74"
  text_p[3].innerHTML = "Highest CTC  -  29LPA"
  text_p[4].innerHTML = "Average CTC  -  10.42LPA"
  t.style.color = "white"
...
function nine(){
    ...
    text_p[1].innerHTML = "Number of Recruiters  -  43"
    text_p[2].innerHTML = "Number of Offers  -  43"
    text_p[3].innerHTML = "Highest CTC  -  27LPA"
    text_p[4].innerHTML = "Average CTC  -  9.15LPA"
