...
function twenty(){
  text_p[0].innerHTML = "Percentage  -  N/A"
  text_p[1].innerHTML = "Number of Recruiters  -  N/A"
  text_p[2].innerHTML = "Number of Offers  -  N/A"
  text_p[3].innerHTML = "Highest CTC  -  N/A"
  text_p[4].innerHTML = "Average CTC  -  N/A"
  t.style.color = "white"
...
function nine(){
    text_p[0].innerHTML = "Percentage  -  82%"
    text_p[1].innerHTML = "Number of Recruiters  -  22"
    text_p[2].innerHTML = "Number of Offers  -  "
    text_p[3].innerHTML = "Highest CTC  -  40.63LPA"
    text_p[4].innerHTML = "Average CTC  -  8.19LPA"
