...
function twenty(){
  text_p[0].innerHTML = "Percentage students placed - 90%"
  text_p[1].innerHTML = "Number of offers - 948"
  text_p[2].innerHTML = "Highest CTC - 46LPA"
  text_p[3].innerHTML = "Average CTC - 9LPA"
  t.style.color = "white"
...
function nine(){
  text_p[0].innerHTML = "Percentage students placed - 70%"
  text_p[1].innerHTML = "Number of offers - 946"
  text_p[2].innerHTML = "Highest CTC - 40LPA"
  text_p[3].innerHTML = "Average CTC - 8-9LPA"
