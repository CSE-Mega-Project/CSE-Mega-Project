...
function twenty(){
  text_p[0].innerHTML = "Percentage - 99.9%"
  text_p[1].innerHTML = "Number of students placed - 133"
  text_p[2].innerHTML = "Highest CTC -  43.30LPA"
  text_p[3].innerHTML = "Median CTC - 15LPA"
  text_p[4].innerHTML = "Average CTC - 24.8LPA"
  t.style.color = "white"
...
function nine(){
    text_p[0].innerHTML = "Percentage  -  98.19%"
    text_p[1].innerHTML = "Number of Students palced  -  113"
    text_p[2].innerHTML = "Highest CTC  -  43LPA"
    text_p[3].innerHTML = "Average CTC  -  22LPA"
    text_p[4].innerHTML = ""
