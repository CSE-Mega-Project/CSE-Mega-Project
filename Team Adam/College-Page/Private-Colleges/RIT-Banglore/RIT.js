...
function twenty(){
  text_p[0].innerHTML = "Number of offers - 1600+"
  text_p[1].innerHTML = "Number of companies - 350+"
  text_p[2].innerHTML = "Highest CTC - 31LPA"
...
function nine(){
  text_p[0].innerHTML = "Number of offers - 1800+"
  text_p[1].innerHTML = "Number of companies - 350+"
  text_p[2].innerHTML = "Highest CTC - 40.63LPA"
  text_p[3].innerHTML = "Average CTC - 7.66LPA"
