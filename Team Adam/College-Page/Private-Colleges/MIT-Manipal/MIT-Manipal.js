...
function twenty(){
  text_p[0].innerHTML = "Placement offers - 973"
  text_p[1].innerHTML = "Number of recruiters - 250+"
  text_p[2].innerHTML = "Highest CTC - 43.31LPA"
  text_p[3].innerHTML = "Median CTC - 6.20LPA"
  text_p[4].innerHTML = "Average CTC - 7.50LPA"
  t.style.color = "white"
...
function nine(){
  text_p[0].innerHTML = "Placement offers - 911"
  text_p[1].innerHTML = "Number of recruiters - 200+"
  text_p[2].innerHTML = "Highest CTC - 39.60LPA"
  text_p[3].innerHTML = "Median CTC - 6.00LPA"
  text_p[4].innerHTML = "Average CTC - 7.48LPA"
