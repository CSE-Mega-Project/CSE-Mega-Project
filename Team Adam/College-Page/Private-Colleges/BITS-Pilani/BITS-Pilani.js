...
function twenty(){
  text_p[0].innerHTML = "Percentage - 99%"
  text_p[1].innerHTML = "Pre-Placement Offers(PPOs) - 173"
  text_p[2].innerHTML = "Number of students placed - 1498"
  text_p[3].innerHTML = "Highest CTC - 45LPA"
  text_p[4].innerHTML = "Median CTC - 15LPA"
  text_p[5].innerHTML = "Average CTC - 18.05LPA"
  t.style.color = "white"
...
function nine(){
    text_p[0].innerHTML = "Percentage  -  88.19%"
    text_p[1].innerHTML = ""
    text_p[2].innerHTML = "Number of Recruiters  -  425+"
    text_p[3].innerHTML = "Highest CTC  -  98.3LPA"
    text_p[4].innerHTML = "Average CTC  -  15.77LPA"
    text_p[5].innerHTML = ""
