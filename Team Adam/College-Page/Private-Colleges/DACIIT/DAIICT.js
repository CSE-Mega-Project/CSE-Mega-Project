...
function twenty(){
  text_p[0].innerHTML = "PPOs - 45+"
  text_p[1].innerHTML = "Number of offers - 245+"
  text_p[2].innerHTML = "Highest CTC - 43.00LPA"
  text_p[3].innerHTML = "Average CTC - 12.32LPA"
  t.style.color = "white"
...
function nine(){
    text_p[0].innerHTML = "PPOs  -  33+%"
    text_p[1].innerHTML = "Number of offers  -  210+"
    text_p[2].innerHTML = "Highest CTC  -  39.30LPA"
    text_p[3].innerHTML = "Average CTC  -  10.16LPA"
