...
function twenty(){
  text_p[0].innerHTML = "Total students placed - 1325"
  text_p[1].innerHTML = "Number of companies - 275"
  text_p[2].innerHTML = "Highest CTC - 52LPA"
  text_p[3].innerHTML = "Average CTC - 12-13LPA"
  t.style.color = "white"
...
function nine(){
  text_p[0].innerHTML = "Total students placed - 1452"
  text_p[1].innerHTML = "Number of companies - 230"
  text_p[2].innerHTML = "Highest CTC - 48.08LPA"
  text_p[3].innerHTML = "Average CTC - 11-12LPA"
